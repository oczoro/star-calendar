 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $0(t=Id()){const e=Oc(t,"auth");return e.isInitialized()?e.getImmediate():JE(t,{popupRedirectResolver:U0,persistence:[W_,L_,zd]})}B0("Browser");const j0=[{path:"/star-calendar/",component:()=>vu(()=>import("./Home.58afe27d.js"),["assets/Home.58afe27d.js","assets/db_api.8d8f5047.js"]),meta:{requiresUnAuth:!0}},{path:"/star-calendar/dashboard",component:()=>vu(()=>import("./Dashboard.720481e2.js"),["assets/Dashboard.720481e2.js","assets/db_api.8d8f5047.js"]),meta:{requiresAuth:!0}}],Zd=Uw({history:Zv(""),routes:j0});function th(){return new Promise((t,e)=>{const n=D_($0(),s=>{n(),t(s)},e)})}Zd.beforeEach(async(t,e,n)=>{t.matched.some(s=>s.meta.requiresUnAuth)?await th()?n("/star-calendar/dashboard"):n():t.matched.some(s=>s.meta.requiresAuth)?await th()?n():n("/star-calendar/"):n()});var H0="firebase",q0="9.6.11";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
